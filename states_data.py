state_regions = {
    "Andhra Pradesh": [
        ...
        "West Godavari", "YSR Kadapa", "Annamayya", "Bapatla", "Eluru", "Kakinada",
        "Nandyal", "NTR", "Palnadu", "Parvathipuram Manyam", "Prakasam", "Sri Potti Sriramulu Nellore",
        "Tirupati", "Alluri Sitharama Raju", "Kurnool"  # some names may repeat due to renaming; adjust as needed
    ],
    "Arunachal Pradesh": [
        "Tawang", "West Kameng", "East Kameng", "Papum Pare", "Tirap",
        "Lohit", "Namsai", "Changlang", "Lower Dibang Valley", "Upper Siang",
        "West Siang", "East Siang", "Upper Subansiri", "Lower Subansiri",
        "Kurung Kumey", "Kra Daadi", "Leparada", "Kamle", "Siang"
    ],
    "Assam": [
        ...
        "Lakhimpur", "Morigaon", "Nagaon", "Nalbari", "Sivasagar", "Sonitpur",
    ...
    "Chhattisgarh": [
        ...
        "Gariaband", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)",
        "Kanker", "Kondagaon", "Korba", "Koriya", "Mahasamund", "Mungeli",
        "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sarguja (Surguja)"
    ],
    "Goa": [
        "North Goa", "South Goa"
    ],
    "Gujarat": [
        ...
        "Patan", "Porbandar", "Rajkot", "Sabarkantha (Sabar Kantha)", "Surat",
        "Surendranagar", "Tapi", "Vadodara", "Valsad"
    ],
    "Haryana": [
        "Ambala", "Bhiwani", "Charkhi Dadri", "Faridabad", "Fatehabad", "Gurugram",
        "Hisar", "Jhajjar", "Jind", "Kaithal", "Karnal", "Kurukshetra", "Mahendragarh",
        "Mewat (Nuh)", "Palwal", "Panchkula", "Panipat", "Rewari", "Rohtak",
    ...
    "Madhya Pradesh": [
        ...
        "Khandwa", "Khargone (West Nimar)", "Mandla", "Mandsaur", "Morena", "Narsinghpur",
    ...
    "Mizoram": [
        "Aizawl", "Kolasib", "Lawngtlai", "Lunglei", "Mamit", "Saitual", "Serchhip", "Champhai", "Hnahthial"
    ],
    "Nagaland": [
        "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", "Niuland",
    ...
    "Tamil Nadu": [
        ...
        "Thiruvarur", "Thoothukudi (Tuticorin)", "Tiruchirappalli", "Tirunelveli",
        "Tirupattur", "Tiruppur", "Tiruvannamalai", "Vellore", "Viluppuram", "Virudhunagar"
    ],
    "Telangana": [
    ...
    "Uttar Pradesh": [
        "Agra", "Aligarh", "Ambedkar Nagar", "Amethi (Chatrapati Sahuji Maharaj Nagar)",
        "Amroha", "Auraiya", "Azamgarh", "Baghpat", "Bahraich", "Ballia",
        "Balrampur", "Banda", "Barabanki", "Bareilly", "Basti", "Bijnor", "Budaun",
        "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria", "Etah", "Etawah", "Faizabad (Ayodhya)",
        "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddh Nagar (Noida)", "Ghaziabad",
    ...
    "West Bengal": [
        ...
        "Paschim Medinipur (West Midnapore)", "Purba Bardhaman", "Purba Medinipur (East Midnapore)",
